    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-gray-200 hover:bg-gray-800 dark:hover:bg-gray-800 border-gray-700"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-gray-800 dark:hover:bg-gray-800"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-gray-900 text-gray-50 hover:bg-gray-800 hover:text-gray-50 focus:bg-gray-900 focus:text-gray-50 dark:hover:bg-gray-800",
