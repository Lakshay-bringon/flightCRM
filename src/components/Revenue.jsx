...
import { DollarSign, AlertTriangle, Search, RotateCcw, Filter, FileText, BarChart2 } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-semibold text-white">Quick Monthly Stats</h2>
        </div>
