...
function Upgrade({ bookingData, onBack }) {
		...
		return (
			<>
				...
				>
					...
					>
						{isSubmitting ? 'Processing Upgrade...' : 'Confirm Upgrade'}
					</button>
				</form>
			</>
		);
	...
	return (
		<BookingComponent
			...
			loadingMessage="Creating upgrade..."
			successMessage="Upgrade created successfully!"
			errorMessage="Failed to create upgrade"
