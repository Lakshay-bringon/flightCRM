			...
			<Body style={main}>
				<Container style={container}>
					...
					<Text>
						...
						association. We shall not be associated with or considered as an
						airline or an ally of any of the airlines or brands. {providerName}
						is shown on your bank account details in most cases. However,
						sometimes we have to split the payment with the airline.
						{providerName} and the airline or another company of that
					...
					<Text>
						...
						us at <a href={`mailto:${providerEmail}`}>{providerEmail}</a>{" "}
