				...
				<div /* style={{ padding: "8px" }} */>
					...
					>
						...
						>
							...
							Your e-tickets will be sent to you via email within 24 hours or
							early if there is no delay from the airline's end. Please note
							that fares are not guaranteed until paid and ticketed. If there
							will be any restrictions, updates, or concerns from the airline,
							we will contact you via email or phone. In case, you would like to
							make any changes to this itinerary after the tickets are issued,
							you will be responsible for the additional penalties, fare
							difference, and fees.
						</div>
						<div
						// style={{
						...
						// }}
						>
							<strong /* style={{ color: "#fbbf24" }} */>Note:</strong> As
							agreed, your credit card may be billed in split charges not
